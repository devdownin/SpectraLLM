...
- **Version de Java clarifiée** : prérequis « JDK 21 ou plus récent » (cible de build 21 — `pom.xml`/CI ; images Docker Temurin 25). La remontée éventuelle de `pom.xml`/CI à 25 reste à trancher (cf. audit, complément C2).
