...
-- Tâches de génération DPO. Ajoutée avec le branchement de la persistance : les trois autres
-- familles de tâches asynchrones (ingestion, génération SFT, fine-tuning) survivaient déjà à un
-- redémarrage, celle-ci était la dernière à disparaître en silence.
