...
Spectra télécharge les modèles par défaut (~2,5 Go), démarre la stack et ouvre l'interface sur **http://localhost**. Déposez un PDF sur la page Ingestion et posez vos questions.
