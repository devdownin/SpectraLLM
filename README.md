...
*Curious how the hybrid fusion, reranking and context compression actually work — and **why**? → **[RAG pipeline internals](docs/tech/rag-pipeline.fr.md)** · **[Architecture](docs/architecture.en.md)***
...
| **[User Manual](docs/user/user-manual.fr.md)** | Complete walkthrough of the web interface |
